            ...
            <div class="bg-white h-full rounded-2xl">
                ...
                <nav class="mt-6">
                    <div>
                        ...
                        <a class="w-full font-thin uppercase text-gray-500 white:text-gray-200 flex items-center p-4 my-2 transition-colors duration-200 justify-start hover:text-blue-500" href="reservation">
                            <span class="text-left">
                        ...
                        <a class="w-full font-thin uppercase text-gray-500 white:text-gray-200 flex items-center p-4 my-2 transition-colors duration-200 justify-start hover:text-blue-500" href="client">
                            <span class="text-left">
                                <svg width="20" height="20" fill="currentColor" class="m-auto" viewBox="0 0 2048 1792" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a class="w-full font-thin uppercase text-gray-500 white:text-gray-200 flex items-center p-4 my-2 transition-colors duration-200 justify-start hover:text-blue-500" href="newRoom">
                            <span class="text-left">
                                <svg width="20" height="20" fill="currentColor" class="m-auto" viewBox="0 0 2048 1792" xmlns="http://www.w3.org/2000/svg">
            ...
            <header class="w-full shadow-lg bg-white white:bg-gray-700 items-center h-16 rounded-2xl z-40">
                <div class="relative z-20 flex flex-col justify-center h-full px-3 mx-auto flex-center">
                    <div class="relative items-center pl-1 flex w-full lg:max-w-68 sm:pr-2 sm:ml-0">
                        ...
                        <div class="relative p-1 flex flex-row w-1/4 ml-5 mr-4 sm:mr-0 sm:right-auto">
