            ...
            <div class="bg-white h-full rounded-2xl">
                ...
                <nav class="mt-6">
                    <div>
                        ...
                        <a class="w-full font-thin uppercase text-gray-500 white:text-gray-200 flex items-center p-4 my-2 transition-colors duration-200 justify-start hover:text-blue-500" href="room">
                            <span class="text-left">
                                <svg width="20" height="20" fill="currentColor" class="m-auto" viewBox="0 0 2048 1792" xmlns="http://www.w3.org/2000/svg">
