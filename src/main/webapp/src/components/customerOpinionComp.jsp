<div class="flex flex-col bg-[#E9C8B8] p-16 mt-10">
    <div class="text-3xl text-[#1E1E1E] font-semibold self-center">What's our customers opinion</div>
    <button type="submit" class="text-sm text-[#1E1E1E] font-medium self-end">View all ></button>
