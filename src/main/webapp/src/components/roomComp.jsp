<div class="flex flex-col bg-[#4B476A] p-16 m-16">
  <div class="text-3xl text-white font-semibold self-center">Our rooms & suites</div>
  <button type="submit" class="text-sm text-white font-medium self-end">View all ></button>
  <div>
    <div class="flex">
        <!-- Start Card -->
